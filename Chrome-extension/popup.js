...
const translations = {
  en: {
    ...
    cloud_sync_quota_exceeded: "Cloud Sync limit reached. Keep up to {sessions} sessions and {urls} URLs in cloud sync.",
  ...
  it: {
    ...
    cloud_sync_quota_exceeded: "Limite Cloud Sync raggiunto. Mantieni fino a {sessions} sessioni e {urls} URL nel cloud sync.",
