...
(function(){
  const i18n = {
    en: {
      ...
      step4_title: "Settings — language, color & backup",
      language: "Language",
    ...
    it: {
      ...
      step4_title: "Impostazioni — lingua, colore e backup",
      language: "Lingua",
    ...
    es: {
      ...
      step4_title: "Ajustes — idioma, color y copia",
      language: "Idioma",
    ...
    de: {
      ...
      step4_title: "Einstellungen — Sprache, Farbe & Backup",
      language: "Sprache",
    ...
    fr: {
      ...
      step4_title: "Paramètres — langue, couleur & sauvegarde",
      language: "Langue",
