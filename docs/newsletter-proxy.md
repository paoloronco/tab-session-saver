...
2. Configure these environment variables on the server:
   - `TSS_N8N_SUBSCRIBE_WEBHOOK_URL`: `https://n8n.prhomelab.com/webhook/tss-subscribe`
...
4. If the proxy is not under `https://n8n.prhomelab.com/*`, update `host_permissions` in `Chrome-extension/manifest.json`.
